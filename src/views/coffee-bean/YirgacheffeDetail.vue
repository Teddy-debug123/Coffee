...
const productData = {
  ...
  brewingGuide: '水温 92℃，粉水比 1:15，建议 2-3 段注水，萃取时长约 1 分 50 秒。',
  notes: ['茉莉花', '柑橘', '蜂蜜', '红茶'],
  specs: ['100g', '250g'],
  prices: { '100g': 68, '250g': 128 },
  image: '/coffee-images/1.jpg',
  images: ['/coffee-images/1.jpg', '/coffee-images/1.jpg', '/coffee-images/1.jpg'],
  story: '耶加雪菲位于埃塞俄比亚西南部，海拔1800-2200米，是世界上最著名的咖啡产区之一。果丁丁村落坐落于埃塞俄比亚西南部耶加雪菲产区，百年原生 Heirloom 老树种，传统水洗处理法，是全球知名花香型精品豆标杆。',
  process: '水洗单一产地',
  altitude: '1800-2200m',
        ...
        <div class="image-box card">
          <div class="image-carousel" @click="openImageModal">
            ...
            <div class="carousel-indicators">
              <span v-for="(_, index) in images" :key="index" class="indicator" :class="{ active: index === currentImageIndex }" @click.stop="currentImageIndex = index"></span>
            </div>
          </div>
        </div>
        ...
        <div v-if="isImageModalOpen" class="image-modal-overlay" @click="closeImageModal">
          <div class="image-modal-content" @click.stop>
            ...
            <div class="modal-indicators">
              <span v-for="(_, index) in images" :key="index" class="indicator" :class="{ active: index === currentImageIndex }" @click="currentImageIndex = index"></span>
            </div>
          </div>
        </div>
      </Transition>
