...
const productData = {
  ...
  brewingGuide: '水温 90℃，粉水比 1:15，两段注水，萃取 2 分钟。',
  notes: ['水蜜桃', '蜜饯', '香草', '黄糖'],
  specs: ['100g', '250g'],
  prices: { '100g': 58, '250g': 108 },
  image: '/coffee-images/7.jpg',
  images: ['/coffee-images/7.jpg', '/coffee-images/7.jpg', '/coffee-images/7.jpg'],
