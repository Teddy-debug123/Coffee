...
const productData = {
  ...
  brewingGuide: '水温 90℃，粉水比 1:14，标准一刀流，萃取 2 分 10 秒。',
  notes: ['坚果', '焦糖', '红莓', '巧克力'],
  specs: ['100g', '250g'],
  prices: { '100g': 52, '250g': 98 },
  image: '/coffee-images/2.jpg',
  images: ['/coffee-images/2.jpg', '/coffee-images/2.jpg', '/coffee-images/2.jpg'],
